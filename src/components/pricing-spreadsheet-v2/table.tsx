...
import { ColumnGroup } from "../../types/pricing-spreadsheet";
...
export default function PricingSpreadsheetTable({
    ...
    const getBgColorFromHeader = (header:any) => {
        ...
        return lightenColor(group?.defaultColor ?? "transparent");
                        ...
                        {columnGroups.map((group) => {
                            ...
                            return (
                                <th
                                    ...
                                    style={{ backgroundColor: group.defaultColor, width: groupWidth }}
                                >
                                    {group.label}
                                </th>
                            );
